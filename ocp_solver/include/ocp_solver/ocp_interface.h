...
namespace ocp_solver {
  ...
  public:
    ...
    void initialize(const std::string& taskName, const std::string& urdfFile, const std::vector<std::string> fixedJointNames, const bool& useAD=false, const std::vector<ContactCandidate>& contactCandidates=std::vector<ContactCandidate>(), const pinocchio::JointModelComposite& baseJointComposite=getBaseJointcomposite());//pinocchio::JointModelFreeFlyer());
